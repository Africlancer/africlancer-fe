...
const authItems: MenuProps['items'] = [
  ...
  {
    label: (
      <a className="flex items-center gap-1 text-lg">
          Sign Up
      </a>
    ),
    key: 'manage',
...
export const NavItems = ({ mode }) => {
  ...
  return (
       <Menu style={{width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end'}} selectedKeys={[current]} mode={mode} items={items} />
  );
};
...
return (
     <Menu style={{width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end'}} selectedKeys={[current]} mode={mode} items={authItems} />
);
};