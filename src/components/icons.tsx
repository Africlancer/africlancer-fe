...
export const ApNotificationIcon: React.ReactNode = (
  <svg
...
export const ApGradHatIcon: React.FC<IProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const ApSuitCaseIcon: React.FC<IProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const ApGoogleIcon: React.FC<IProps> = ({ className }) => (
...
export const ApFacebookIcon: React.FC<IProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="blue" width="24" height="22" viewBox="0 0 24 24">
