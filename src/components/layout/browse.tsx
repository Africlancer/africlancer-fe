...
export const BrowseLayout: React.FC<IProps> = ({
  FilterComponent,
  MainContent,
  page,
  browseFunc,
        ...
        <div className="relative h-80 w-full bg-browse-hero-pattern bg-center bg-cover">
          <div className="absolute p-10 pb-16 h-full w-full bg-black/40 text-white flex flex-col justify-between">
            <div>
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam placeat dolore aut
                culpa iste sint inventore est assumenda iusto voluptas praesentium quod minima
                perferendis quidem ut quia harum, repellat ratione quaerat. Eligendi obcaecati,
                dolorem repellat assumenda minima impedit expedita, voluptatem tempore eveniet unde
                ut minus exercitationem atque eum perferendis sint.
              </p>
            </div>
