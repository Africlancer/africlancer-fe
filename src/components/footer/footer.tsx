...
export const Footer = () => {
  return (
    <footer className="w-full pt-8 px-10 bg-footer text-white">
      <div>
        <div className="flex items-center justify-between h-full">
          ...
          <div className="bg-green-500 w-96 p-8 rounded-lg">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa optio omnis
              praesentium fugiat sunt laudantium facilis similique ipsam cupiditate voluptate?
            </p>
            <div className="w-full h-0.5 bg-white my-2"></div>
            <div className="flex flex-col items-end">
              <p className="mb-1">
                <GlobeIcon style={{ color: 'white', fontSize: '20px' }} /> US (International) -
                English
              </p>
              <p>
                <QuestionCircleFilled /> Help and Support
              </p>
        ...
        <div className="py-5">
          ...
          <p className="text-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae nostrum harum quo,
            numquam accusamus culpa quos aliquam laudantium cupiditate! Dolore.
          </p>
        </div>
      </div>
    </footer>
