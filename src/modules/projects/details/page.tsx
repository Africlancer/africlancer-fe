...
export const ProjectDetailsPage = ({ id }) => {
  ...
  const { getTotalBids, projectTotalBids, findBids, projectBids, getAverageBid, averageBid } =
    useBiddingContext()
                ...
                <div className="w-full">
                    ...
                    {status && (
                      <div className="flex gap-2 items-center">
                        <h1 className="font-medium">
                          Bidding Status <span className="ml-1">:</span>
                        </h1>
                        <div
                          className={`${
                            status === 'OPEN'
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <p className="font-medium">
                      ${activeProject?.minBudget} - {activeProject?.maxBudget} USD
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-end flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="font-bold text-lg">
                      {hasBiddingEnded
                        ? 'Bidding has officially ended for this project'
                        : daysLeft === 1
                        ? `Bidding ends in ${daysLeft} day`
          ...
          <div className="flex justify-between w-full gap-5">
            <div className="flex flex-col gap-10 w-full">
              <div className="bg-skin-base shadow-md rounded-md min-w-[60%]">
                ...
                <div className="bg-skin-base shadow-md rounded-md min-w-[60%]">
                  {current === 'proposals' ? (
                    <Proposals userProposal={data?.findOneBid.userID} projectId={id} />
                  ) : (
                    <Details
