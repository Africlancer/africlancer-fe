        ...
        <div className="relative h-80 w-full bg-browse-hero-pattern bg-center bg-cover">
          <div className="absolute h-full w-full bg-black/40 text-white flex flex-col justify-between">
            <div className="px-10 pt-8">
              ...
              <p className="mb-5">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorum ut, vel assumenda
                odio pariatur officia repudiandae! Est et reprehenderit, voluptatibus fuga quo ut
                nobis dolore aut non sit tempora expedita facilis aperiam distinctio consequatur
                delectus libero a, possimus quod voluptates aspernatur cum. Magnam ab nesciunt
                doloremque nostrum, aperiam rem voluptatem.
              </p>
              <ApSearchInput />
            </div>
          </div>
                    ...
                    {projects?.map((project) => {
                      ...
                      return (
                        <tr className="" key={(project as any)?._id}>
                          ...
                          <td className="whitespace-nowrap px-6 py-4"></td>
                          <td className="whitespace-nowrap px-6 py-4">
                            ${(project as any)?.minBudget} - {(project as any)?.maxBudget}
                          </td>
                          <td className="whitespace-nowrap px-6 py-4">
                            {(project as any)?.type === projectPaymentType.fixed
                              ? 'Fixed'
                              : 'Hourly'}
                          </td>
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            {(project as any)?.status === projectBidStatus.open
                              ? 'Open'
                              : (project as any)?.status === projectBidStatus.close
                              ? 'Closed'
                              : 'Completed'}
                          </td>
                          <td className="whitespace-nowrap px-6 py-4">
