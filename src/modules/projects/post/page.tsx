...
import { LoadingOutlined, ScheduleFilled } from '@ant-design/icons'
  ...
  return (
    <div className="h-full bg-skin-alt">
      ...
      <div className="pt-[62px]">
        <div
          className="w-full bg-center bg-cover h-[450px]"
        ...
        >
          <div className="text-white h-full w-full bg-overlay2 flex flex-col items-center pt-32">
            <div className="w-[800px]">
              ...
              <p className="text-lg">
                Contact skilled freelancers within minutes. View profiles, ratings, portfolios and
                chat with them. Pay the freelancer only when you are 100% satisfied with their
                work.
              </p>
            </div>
          </div>
