        ...
        <div className='pt-[100px]'>
            <div className='relative h-80 w-full bg-browse-hero-pattern bg-center bg-cover'>
                <div className='absolute p-10 h-full w-full bg-black/40 text-white flex flex-col justify-between'>
                    <div>
                        <h1 className='font-bold text-4xl mb-2'>My Groups</h1>
            ...
            <div className='flex items-center justify-center pt-20 pb-20 h-full w-full gap-10'>
                <div className="bg-white w-96 shadow-lg rounded-md ">
                    <div className='relative w-full h-52'>
                        <Image className='rounded-t-md' alt='ob' src={Onboarding} fill/>
                        <div className='absolute bg-black/20 h-full w-full rounded-t-md'>

                        </div>
                        <div className="bg-white rounded-full p-2 absolute left-3 top-3">
                            <Image src={Logo} height={25} alt="Logo" width={25}/>
                        </div>
                    </div>
                    <div className='px-5 py-3'>
                        <h1 className='font-bold text-lg mb-2'>Freelancer Onboarding</h1>
                ...
                <div className="bg-white w-96 shadow-lg rounded-md ">
                    <div className='relative w-full h-52'>
                        <Image className='rounded-t-md' alt='ob' src={Announce} fill/>
                    ...
                    <div className='px-5 py-3'>
                        <h1 className='font-bold text-lg mb-2'>General Announcements</h1>
                        <p >The latest news and announcements from Freelancer.</p>
                        <div className='flex justify-between items-end mt-5'>
                            <div className='text-sm flex gap-2'>
                                <p className='font-bold'>Last Active</p> 
                                <p>:</p>
