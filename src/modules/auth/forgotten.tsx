    ...
    <div className="flex flex-col items-center justify-top py-2 bg-gray-100 min-h-screen">
     <main className=" flex-col items-center justify-center text-center ">
        <div className="bg-white rounded shadow-sm px-6 py-14 mt-3">
            ...
            <h3 className="text-2xl justify-center w-full text-black font-semibold">Reset your password</h3>
            </div>
            <div className="flex items-center justify-center mb-4">
                <p className=" text-sm justify-between  text-black font-medium">Enter your Africlancer.com email address so we can reset your password</p>
            </div>
