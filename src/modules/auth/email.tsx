        ...
        <div className="bg-white rounded shadow-sm px-6 py-14 mt-3">
          ...
          <div className="flex items-center justify-center mb-4">
            <p className=" text-sm justify-between  text-black font-medium">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Velit, consequuntur? Odio
              rem commodi officiis, sapiente repellendus itaque repudiandae magnam alias sit. Iusto
              nostrum odio dignissimos ipsam ut quisquam eos pariatur.
            </p>
          </div>
