    ...
    <main className="flex items-center justify-center text-center">
        ...
        <div className="bg-white w-96 p-6 rounded shadow-sm">
          <div className="flex items-center justify-center mb-4">
            <h1 className="text-black font-extrabold fonts-red-hat text-4xl">Afric<span className="text-green-500 ">lancer</span>
            </h1>
          </div>
          <div className="flex justify-center mb-4">
            <h3 className="text-2xl justify-between w-full text-black font-semibold">Reset your password</h3>
            </div>
            <div className="flex items-center justify-center mb-4">
                <p className=" text-sm justify-between  text-black font-medium">Choose your new password </p>
            </div>
          ...
          <button
            ...
            className="text-white bg-green-500 w-full text-white-100 py-2
                    rounded hover:bg-green-600 transition colors rounded-lg font-serif">Submit
          </button>
        </div>
