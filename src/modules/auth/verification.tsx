      ...
      <main className=" flex-col items-center justify-center text-center mt-3">
        <div className="bg-white rounded shadow-sm py-2 px-10 w-fit">
          <div className=" flex items-center justify-center  mb-10">
            <h1 className="text-5xl  text-red-hat flex items-center text-left w-full text-black font-extrabold">
              Welcome to Africlancer.com
            </h1>
          </div>
          <div className="flex items-center justify-center mb-5">
            <h4 className="text-lg text-left w-full text-black font-bold">Hi User</h4>
          </div>
          <div className="flex items-center justify-center mb-7">
            <p className="text-lg text-left w-full text-black">
              Welcome to africlancer.com,Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Neque, voluptatum reiciendis! Obcaecati nulla quod alias dolores veniam corporis
              laboriosam voluptatem assumenda repellendus debitis, dolorem officiis aspernatur
              numquam velit rerum! Repudiandae.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center mb-5">
            <p className="text-lg text-left w-full text-black">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Architecto soluta eaque
              blanditiis explicabo quia, animi unde dolore minus totam voluptatibus. Laudantium,
              temporibus maxime voluptatibus voluptatem aliquam incidunt enim in? Obcaecati.
            </p>
          </div>
          <div className="flex-col mb-5 text-lg text-left">
            Regards,
