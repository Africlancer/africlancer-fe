...
export const CreateBid = ({projectID}) => {
    ...
    const {createBid} = useBiddingContext()
            ...
            >
                <Form>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='mt-0.5'>You will be able to edit your bid until the project is awarded to someone.</p>
                    </div>
                    <div className='flex justify-between gap-8 mt-5'>
                        <ApTextInput inputType='number' name='budget' label='Your Budget'/>
                        <ApTextInput inputType='number' name='deliveredIn' label='This project will be delivered in'/>
                    </div>
