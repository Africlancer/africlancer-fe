          ...
          <div className="flex gap-5 items-start">
            <div className="flex flex-col gap-5">
              <div className="bg-skin-base rounded-lg shadow-lg p-7">
                ...
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est autem animi fugit
                  explicabo, error id accusantium labore sint fuga, dicta, consequuntur doloremque
                  odit. Est, cum. Non atque repudiandae commodi, aspernatur exercitationem
                  doloribus a delectus, vitae saepe dignissimos aut impedit quae ea enim
                  necessitatibus quos beatae iure. Fugiat animi harum obcaecati.
                </p>
            ...
            <div className="flex flex-col gap-5 sticky top-0">
              ...
              <div className="p-5 bg-skin-base rounded-lg shadow-lg w-96">
                <div>
                  <div className="flex justify-between">
                    <p>Balance</p>
                    <p className="text-skin-accent flex gap-2">
                      <PlusCircleOutlined />
                      Add Funds
                    </p>
                  </div>
