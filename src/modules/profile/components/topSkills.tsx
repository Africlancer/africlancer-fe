...
export const TopSkills = () => 
{
    return (
            ...
            <div className='h-64 flex items-center w-full justify-center flex-col'>
                    <div className='px-8 flex flex-wrap justify-center gap-5'>
                        ...
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Mobile Development</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>C++</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Angular JS</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Vue JS</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Nest JS</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Express JS</p>
                        <p className='bg-gray-100 inline-block py-1 px-3 rounded-lg'>Solid JS</p>
                    </div>
            </div>                
        </div>
    );
