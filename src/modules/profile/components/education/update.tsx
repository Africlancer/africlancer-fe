...
export const UpdateEducation: React.FC<IProps> = ({ setModal, modal }) => {
  ...
  const handleSubmit = async (val) => {
    ...
    addEducation({
      ...
      .then((val) => {
        if (val) {
          successMsg(`Success`, `Education Info has been updated.`)
          setTimeout(() => {
            setModal({ open: false })
          }, 1000)
        }
      ...
      <div>
        ...
        <Formik
          initialValues={{
            ...
            insitution: modal.data.insitution,
            degree: modal.data.degree,
          ...
          <Form>
            <div className="flex w-full  gap-5">
              <div className="w-full">
                <ApSelectInput name="country" label="Country">
            ...
            <div className="flex w-full items-center gap-5 mt-5">
              ...
              <div className="w-full">
                <ApSelectInput name="endYear" label="End Year">
                  <option selected disabled>
                    Select Year
                  </option>
                  {years.map((year) => (
