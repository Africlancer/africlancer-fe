...
export const Verification = () => {
  return (
    ...
    <div className='border-skin-border border-b px-6 py-2 flex items-center'>
        <h1 className='font-bold text-xl mr-3 text-skin-inverted'>Verfications</h1>
    ...
    <div className='p-8 flex justify-between flex-col h-72 text-skin-inverted'>
        <div className='flex justify-between mb-7'>
            ...
            <a className='text-skin-accent'>Verify</a>
        </div>
