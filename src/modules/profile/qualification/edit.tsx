  ...
  return (
    <div>
      ...
      <div className='w-full'>
        ...
        <input type="text" placeholder='Enter Professional Certificate or Award' className='w-full border rounded p-3 h-10' />
      </div>

      <div className='w-full'>
        <p className='mb-2'>Conferring Organization</p>
        <input type="text" placeholder='Enter Conferring Organization' className='w-full border rounded p-3 h-10' />
      </div>
      </div>
      ...
      <div>
        ...
        <textarea placeholder='Describe Your Qualification' className='border w-full rounded p-3 h-40 resize-none'></textarea>
      </div>
