      ...
      <div className="px-10">
        <div className="border-b text-skin-inverted border-skin-border w-full pb-5">
          ...
          <p className="text-lg ring-offset-indigo-800">
            Quickly Get Your Work Completed By Our Top Notch African Freelancers
          </p>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-10">
          <div className="bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-xl p-5">
            ...
            <p className="text-lg text-skin-inverted">
              It’s free and easy to post a job. Simply fill in a title, description and budget and
          ...
          <div className="bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5">
            ...
            <p className="text-lg text-skin-inverted">
              No job is too big or too small. We&apos;ve got freelancers for jobs of any size or
              budget, across 1800+ skills.
            </p>
          </div>
          ...
          <div className="bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5">
            ...
            <p className="text-lg text-skin-inverted">
              Only pay for work when it has been completed and you&apos;re 100% satisfied with the
          ...
          <div className="bg-skin-base rounded-lg w-full shadow-lg p-6">
            ...
            <p className="text-lg text-skin-inverted">
              Our talented team of recruiters can help you find the best freelancer for the job,
