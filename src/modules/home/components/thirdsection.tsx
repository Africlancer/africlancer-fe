        ...
        <div className='grid grid-cols-4 gap-4 mt-10'>
            <div className='bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5'>
              ...
              <FolderFilled style={{fontSize: '30px'}}/>
                ...
                <p className='text-lg text-skin-inverted'>Find professionals you can trust by browsing their samples of previous work and reading their profile reviews.</p>
            </div>
            ...
            <div className='bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5'>
              ...
              <ScheduleFilled style={{fontSize: '30px'}}/>
                ...
                <p className='text-lg text-skin-inverted'>Receive obligation free quotes from our talented freelancers fast. 80% of projects get bid on within 60 seconds.</p>
            </div>
            ...
            <div className='bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5'>
              ...
              <CheckCircleFilled style={{fontSize: '30px'}}/>
                ...
                <p className='text-lg text-skin-inverted'>Freelancer.com has by far the largest pool of quality freelancers globally- over 50 million to choose from.</p>
            </div>
            ...
            <div className='bg-skin-base rounded-lg w-full flex flex-col justify-center shadow-lg p-5'>
              ...
              <ClockCircleFilled style={{fontSize: '30px'}}/>
                ...
                <p className='text-lg text-skin-inverted'>Keep up-to-date and on-the-go with our time tracker, and mobile app. Always know what freelancers are up to.</p>
            </div>
        </div>
      </div>
    </div>
