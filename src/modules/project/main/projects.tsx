    ...
    <div>
      ...
      <div className="px-5 py-3 border-b">
        ...
        <div className="flex justify-between">
          ...
          <p
            ...
            onClick={() => clearQuery('type', typeFormRef)}
          >
            Clear
          </p>
        </div>
      ...
      <div className="px-5 py-3 border-b">
        <div className="flex justify-between">
          ...
          <p
            className="text-skin-accent cursor-pointer"
            onClick={() => clearQuery('budget', budgetFormRef)}
          >
            Clear
          </p>
        </div>
        ...
        <form>
          <div className="flex flex-col gap-2 mb-2">
            <p>Min Budget</p>
            <input
              disabled={filterQuery.type ? false : true}
              ...
              onChange={({ target }) => {
                if (target.value === '') {
                  ...
                  setFilterQuery({ ...filterQuery, minBudget: parseInt(target.value) })
                }
              }}
            />
          </div>
            ...
            <input
              ...
              onChange={({ target }) => {
                if (target.value === '') {
                  ...
                  setFilterQuery({ ...filterQuery, maxBudget: parseInt(target.value) })
                }
              }}
            />
          </div>
          ...
          <div>
            {projects?.length > 0 ? (
              ...
              <div className="flex items-center justify-center h-[200px]">
                <p className="flex items-center gap-3">No Projects Found</p>
              </div>
            )}
          </div>
        ) : (
